...
import IconFileDownload from "https://deno.land/x/tabler_icons_tsx@0.0.2/tsx/file-download.tsx";
...
const Sidebar = (
  ...
  return (
    <aside class="lg:sticky lg:top-0 lg:max-h-screen lg:h-screen lg:py-24 lg:w-1/2 py-12 flex flex-col justify-between">
      ...
      <div class="mt-10 lg:mt-0 flex items-center gap-5">
        <a
        ...
        >
          <IconFileDownload class="w-5 h-5" />
        </a>
      </div>
    </aside>
  );
